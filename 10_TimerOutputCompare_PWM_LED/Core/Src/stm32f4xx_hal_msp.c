...
void HAL_TIM_PWM_MspInit(TIM_HandleTypeDef *htim)
{
	...
	GPIO_InitTypeDef tim2_OC_gpio;

	//1. Enable the Peripheral Clock for the timer2 Peripheral
	__HAL_RCC_TIM2_CLK_ENABLE();
	__HAL_RCC_GPIOB_CLK_ENABLE();

	//2. Configure the GPIOs to behave as TIM2 channel 1,2,3,4
	/*
	 * PA8	--- >  Channel 1
	 * PA9	--- >  Channel 2
	 * PA10	--- >  Channel 3
	...
	tim2_OC_gpio.Alternate 	= GPIO_AF1_TIM2;
	HAL_GPIO_Init(GPIOB, &tim2_OC_gpio);
